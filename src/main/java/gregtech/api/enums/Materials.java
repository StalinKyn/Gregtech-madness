...
public class Materials implements IColorModulationContainer, ISubTagContainer {
     ...
     */
    @Deprecated public static Materials IridiumAndSodiumOxide, Palygorskite, Adamantine, Ashes, DarkAshes, Abyssal, Adamant, AluminumBrass, Aluminum, NaturalAluminum, NaturalAluminium,
    Americum, Beryl, BlackGranite, CalciumCarbonate, CrackedLightFuel, CrackedHeavyFuel, CreosoteOil, Chromium, Diesel, Enderpearl, Endereye, EyeOfEnder, Eyeofender,
    Flour, Meat, Garnet, Granite, Goethite, Kalium, Lapislazuli, LapisLazuli, Monazit, Natrium, Mythril, NitroDiesel, Naquadriah, Obby, Peridot, Phosphorite, Quarried,
    Quicksilver, QuickSilver, RedRock, RefinedIron, RedGranite, Sheldonite, Soulsand, Titan, Uran, Wolframite, Wolframium, Wolfram, Phosphor;
    ...
    public static void initMaterials(){
        ...
        Spartackium = new Materials(1019, TextureSet.SET_DULL, 	   10.0F, 128, 10, 1|2|8|32|64|128, 200, 120, 120, 0, "Spartackium", "Spartackium", 0, 0, 933, 1700, true, false, 3, 1, 1, Dyes.dyeLightBlue, Element.SP, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.VOLATUS, 1)));
        ...
        Argon = new Materials(24, TextureSet.SET_FLUID, 		1.0F, 0, 2, 16|32, 0, 255, 0, 240, "Argon", "Argon", 0, 0, 83, 0, false, true, 5, 1, 1, Dyes.dyeGreen, Element.Ar, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.AER, 2))).setHasCorrespondingFluid(true).setHasCorrespondingGas(true).setCompressionRatio(20);
        ...
        Deuterium = new Materials(2, TextureSet.SET_FLUID, 		1.0F, 0, 2, 16|32, 255, 255, 0, 240, "Deuterium", "Deuterium", 0, 0, 14, 0, false, true, 10, 1, 1, Dyes.dyeYellow, Element.D, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.AQUA, 3))).setHasCorrespondingLiquefiedGasFluid(true).setLiquidTemperature(24).setCompressionRatio(250);
        ...
        Helium = new Materials(4, TextureSet.SET_FLUID, 		1.0F, 0, 2, 16|32, 255, 255, 0, 240, "Helium", "Helium", 0, 0, 1, 0, false, true, 5, 1, 1, Dyes.dyeYellow, Element.He, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.AER, 2))).setHasCorrespondingLiquefiedGasFluid(true).setLiquidTemperature(4).setCompressionRatio(500);
        ...
        Krypton = new MaterialBuilder(799, TextureSet.SET_FLUID,"Krypton").addFluid().addGas().setLiquidTemperature(100).setGasTemperature(300).addCell().setRGB(20,240,40).constructMaterial();
        ...
        Neon = new MaterialBuilder(798,TextureSet.SET_FLUID,"Neon").addFluid().addGas().setLiquidTemperature(100).setGasTemperature(300).addCell().setRGB(10,80,240).constructMaterial();
        ...
        Nitrogen = new MaterialBuilder(12, TextureSet.SET_FLUID, "Nitrogen").setRGBA(0,150,200,240).addCell().addPlasma().setElement(Element.N).setColor(Dyes.dyeCyan).setAspects(Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.AER, 2))).addFluid().setLiquidTemperature(100).addGas().setGasTemperature(300).constructMaterial();
        ...
        Oxygen = new Materials(13, TextureSet.SET_FLUID, 		1.0F, 0, 2, 16|32, 0, 100, 200, 240, "Oxygen", "Oxygen", 0, 0, 54, 0, false, true, 1, 1, 1, Dyes.dyeWhite, Element.O, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.AER, 1))).setHasCorrespondingFluid(true).setLiquidTemperature(90).setHasCorrespondingGas(true).setGasTemperature(300).setCompressionRatio(860);
        ...
        Xenon = new MaterialBuilder(7,TextureSet.SET_FLUID,"Xenon").addGas().addFluid().setLiquidTemperature(100).setGasTemperature(300).setCompressionRatio(20).setRGB(220,20,110).addCell().constructMaterial();
        ...
        ConductiveIron = new Materials(-1, TextureSet.SET_NONE, 1.0F, 0, 2, 1|2, 255, 255, 255, 0, "ConductiveIron", "Conductive Iron", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes._NULL);
        ElectricalSteel = new Materials(-1, TextureSet.SET_NONE,1.0F, 0, 2, 1|2, 255, 255, 255, 0, "ElectricalSteel", "Electrical Steel", 0, 0, 1811, 1000, true, false, 3, 1, 1, Dyes._NULL);
        EnergeticAlloy = new Materials(-1, TextureSet.SET_NONE, 1.0F, 0, 2, 1|2, 255, 255, 255, 0, "EnergeticAlloy", "Energetic Alloy", 0, 0, 1950, 1950, true, false, 3, 1, 1, Dyes._NULL);
        VibrantAlloy = new Materials(-1, TextureSet.SET_NONE, 	1.0F, 0, 2, 1|2, 255, 255, 255, 0, "VibrantAlloy", "Vibrant Alloy", 0, 0, 3300, 3300, true, false, 3, 1, 1, Dyes._NULL);
        PulsatingIron = new Materials(-1, TextureSet.SET_NONE, 	1.0F, 0, 2, 1|2, 255, 255, 255, 0, "PulsatingIron", "Pulsating Iron", 0, 0, 1600, 1600, true, false, 3, 1, 1, Dyes._NULL);
        ...
        ElectrumFlux = new Materials(320, TextureSet.SET_SHINY,16.0F, 512, 3, 1|2|64, 255, 255, 120, 0, "ElectrumFlux", "Fluxed Electrum", 0, 0, 3000, 3000, true, false, 1, 1, 1, Dyes.dyeYellow);
         ...
         */
        //  Neon = new MaterialBuilder(420,TextureSet.SET_FLUID,"Neon").setRGB(50,20,200).addGas().setGasTemperature(400).addFluid().setLiquidTemperature(85).setCompressionRatio(20).addCell().constructMaterial();
        //   Krypton = new MaterialBuilder(421,TextureSet.SET_FLUID,"Krypton").setRGB(200,123,20).addGas().setGasTemperature(475).setLiquidTemperature(95).setCompressionRatio(20).addCell().constructMaterial();
        //   Xenon = new MaterialBuilder(422,TextureSet.SET_FLUID,"Xenon").setGasTemperature(275).setLiquidTemperature(80).addFluid().addGas().setRGB(10,240,50).setCompressionRatio(20).addCell().constructMaterial();
        Methane = new Materials(715, TextureSet.SET_FLUID, 			1.0F, 0, 1, 16, 255, 255, 255, 0, "Methane", "Methane", 1, 104, -1, 0, false, false, 3, 1, 1, Dyes.dyeMagenta, 1, Arrays.asList(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 4))).setHasCorrespondingGas(true).setGasTemperature(300).setHasCorrespondingFluid(true).setLiquidTemperature(112).setCompressionRatio(2);
        CarbonDioxide = new Materials(497, TextureSet.SET_FLUID, 	1.0F, 0, 2, 16|32, 169, 208, 245, 240, "CarbonDioxide", "Carbon Dioxide", 0, 0, 25, 1, false, true, 1, 1, 1, Dyes.dyeLightBlue, 0, Arrays.asList(new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 2))).setHasCorrespondingGas(true).setHasCorrespondingLiquefiedGasFluid(true).setLiquidTemperature(50).setCompressionRatio(200);
        NobleGases = new Materials(496, TextureSet.SET_FLUID, 		1.0F, 0, 2, 16|32, 169, 208, 245, 240, "NobleGases", "Noble Gases", 0, 0, 4, 0, false, true, 1, 1, 1, Dyes.dyeLightBlue, 2, Arrays.asList(new MaterialStack(CarbonDioxide, 21), new MaterialStack(Helium, 9), new MaterialStack(Methane, 3), new MaterialStack(Deuterium, 1))).setHasCorrespondingFluid(true).setLiquidTemperature(79).setCompressionRatio(450);
        Air = new Materials(-1, TextureSet.SET_FLUID, 				1.0F, 0, 2, 16|32, 169, 208, 245, 240, "Air", "Air", 0, 0, -1, 0, false, true, 1, 1, 1, Dyes.dyeLightBlue, 0, Arrays.asList(new MaterialStack(Nitrogen, 40), new MaterialStack(Oxygen, 11), new MaterialStack(Argon, 1), new MaterialStack(NobleGases, 1))).setHasCorrespondingLiquefiedGasFluid(true).setCompressionRatio(1000).setLiquidTemperature(74).setLiquefiedRGBa(new short[]{200,150,250});
        TrueAir = new MaterialBuilder(996,TextureSet.SET_FLUID,"Air").addGas().addFluid().setGasTemperature(300).setLiquidTemperature(100).setCompressionRatio(1000).setRGBA(255,255,255,30).addCell().constructMaterial();
        LiquidAir = new Materials(495, TextureSet.SET_FLUID, 		1.0F, 0, 2, 16|32, 169, 208, 245, 240, "LiquidAir", "Liquid Air", 0, 0, 4, 0, false, true, 1, 1, 1, Dyes.dyeLightBlue, 2, Arrays.asList(new MaterialStack(Nitrogen, 40), new MaterialStack(Oxygen, 11), new MaterialStack(Argon, 1), new MaterialStack(NobleGases, 1))).setHasCorrespondingFluid(true).setLiquidTemperature(79).setCompressionRatio(700);
    ...
    public short[] mLiquefiedRGBa = new short[]{-1,255,255,0};
    ...
    public short mMeltingPoint = 0, mBlastFurnaceTemp = 0, mGasTemp = 0, mLiquefyTemp, compressionRatio;
    public int mTypes = 0;
    ...
    public int mDensityMultiplier = 1, mDensityDivider = 1, mWorkerTier = 0;
    ...
    public boolean mHasParentMod = true, mHasPlasma = false, mHasGas = false, mCustomOre = false, mHasLiquefiedGas = false;
    public Fluid mSolid = null, mFluid = null, mGas = null, mPlasma = null;

    private boolean hasCorrespondingFluid = false, hasCorrespondingGas = false, hasCorrespondingLiquefiedGasFluid,canBeCracked = false;
    ...
    public static void init() {
        ...
        for (Materials aMaterial : MATERIALS_ARRAY) {
            if (aMaterial.mMetaItemSubID >= 0) {
                ...
                } else if (aMaterial.mMetaItemSubID<2000){
                    if (aMaterial.mHasParentMod) {
                        if (GregTech_API.sGeneratedMaterials[aMaterial.mMetaItemSubID] == null) {
                            GregTech_API.sGeneratedMaterials[aMaterial.mMetaItemSubID] = aMaterial;
                        } else throw new IllegalArgumentException("The Material Index " + aMaterial.mMetaItemSubID + " for " + aMaterial.mName + " is already used!");
                    }
                }else throw new IllegalArgumentException("The Material Index " + aMaterial.mMetaItemSubID + " for " + aMaterial.mName + " is/over the maximum of 2000");
            }
        }
    ...
    public Materials(int aMetaItemSubID, TextureSet aIconSet, float aToolSpeed, int aDurability, int aToolQuality, int aTypes, int aR, int aG, int aB, int aA, String aName, String aDefaultLocalName, int aFuelType, int aFuelPower, int aMeltingPoint, int aBlastFurnaceTemp, boolean aBlastFurnaceRequired, boolean aTransparent, int aOreValue, int aDensityMultiplier, int aDensityDivider, Dyes aColor, String aConfigSection, boolean aCustomOre, String aCustomID) {
        ...
        mWorkerTier = Math.min(9,aBlastFurnaceRequired?mBlastFurnaceTemp/900+1:1);
    }
    ...
    public Materials(int aMetaItemSubID, TextureSet aIconSet, float aToolSpeed, int aDurability, int aToolQuality, int aTypes, int aR, int aG, int aB, int aA, String aName, String aDefaultLocalName, int aFuelType, int aFuelPower, int aMeltingPoint, int aBlastFurnaceTemp, boolean aBlastFurnaceRequired, boolean aTransparent, int aOreValue, int aDensityMultiplier, int aDensityDivider, Dyes aColor, Element aElement, List<TC_Aspects.TC_AspectStack> aAspects, short aLiquefyTemp) {
        this(aMetaItemSubID, aIconSet, aToolSpeed, aDurability, aToolQuality, aTypes, aR, aG, aB, aA, aName, aDefaultLocalName, aFuelType, aFuelPower, aMeltingPoint, aBlastFurnaceTemp, aBlastFurnaceRequired, aTransparent, aOreValue, aDensityMultiplier, aDensityDivider, aColor);
        mLiquefyTemp = aLiquefyTemp;
    }
    ...
    public static String getLocalizedNameForItem(String aFormat, int aMaterialID) {
    	if (aMaterialID >= 0 && aMaterialID < 2000) {
	...
	public Materials setHasCorrespondingLiquefiedGasFluid(boolean hasCorrespondingLiquefiedGasFluid){
        this.hasCorrespondingLiquefiedGasFluid = hasCorrespondingLiquefiedGasFluid;
        return this;
    }

    public boolean hasCorrespondingLiquefiedGasFluid(){
        return this.hasCorrespondingLiquefiedGasFluid;
    }

    public Materials setLiquefiedRGBa(short[] aRGBa){
        if(aRGBa.length==4)
          this.mLiquefiedRGBa = aRGBa;
        return this;
    }
    ...
    public Materials setCompressionRatio(int compressionRatio){
        this.compressionRatio = (short) compressionRatio;
        return this;
    }
    ...
    public Materials setElement(Element aElement){
        mElement = aElement;
        return this;
    }

    public Materials setWorkerTier(int aTier){
        mWorkerTier = aTier;
        return this;
    }
