...
public class Textures {
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        MACHINE_UV_SIDE, MACHINE_UV_BOTTOM, MACHINE_UHV_TOP, MACHINE_UHV_SIDE, MACHINE_UHV_BOTTOM, MACHINE_UEV_TOP, MACHINE_UEV_SIDE, MACHINE_UEV_BOTTOM, MACHINE_UIV_TOP,
        MACHINE_UIV_SIDE, MACHINE_UIV_BOTTOM,MACHINE_MAX_TOP, MACHINE_MAX_SIDE, MACHINE_MAX_BOTTOM, MACHINE_BRONZEPLATEDBRICKS, MACHINE_HEATPROOFCASING, MACHINE_COIL_SUPERCONDUCTOR,
        ...
        MACHINE_CASING_GEARBOX_BRONZE, MACHINE_CASING_GEARBOX_STEEL, MACHINE_CASING_GEARBOX_TITANIUM, MACHINE_CASING_GEARBOX_TUNGSTENSTEEL, MACHINE_CASING_DATA_DRIVE, MACHINE_CASING_CONTAINMENT_FIELD, MACHINE_CASING_PIPE_HSSG, MACHINE_CASING_DURABLE_HSSG,MACHINE_CASING_SUPERHEATPROOF,
        ...
        MACHINE_CASING_RADIATIONPROOF, MACHINE_CASING_FIREBOX_BRONZE, MACHINE_CASING_FIREBOX_STEEL, MACHINE_CASING_FIREBOX_TUNGSTENSTEEL, MACHINE_CASING_FIREBOX_HSSG,MACHINE_CASING_ENGINE_INTAKE, MACHINE_CASING_CHEMICALLY_INERT, MACHINE_COIL_CUPRONICKEL,
        MACHINE_CASING_DENSEBRICKS, MACHINE_CASING_BRICKEDBLASTFURNACE_ACTIVE, MACHINE_CASING_BRICKEDBLASTFURNACE_INACTIVE, MACHINE_CASING_RUBBER, CASING_WIRE,
        ...
        HUGETURBINE_ST1, HUGETURBINE_ST2,  HUGETURBINE_ST3,  HUGETURBINE_ST4,  HUGETURBINE_ST5,  HUGETURBINE_ST6,  HUGETURBINE_ST7,  HUGETURBINE_ST8,  HUGETURBINE_ST9,
        HUGETURBINE_ST10, HUGETURBINE_ST11,  HUGETURBINE_ST12,  HUGETURBINE_ST14,  HUGETURBINE_ST15,  HUGETURBINE_ST16,  HUGETURBINE_ST17,  HUGETURBINE_ST18,
        HUGETURBINE_ST19, HUGETURBINE_ST20,  HUGETURBINE_ST21,  HUGETURBINE_ST22,  HUGETURBINE_ST23,  HUGETURBINE_ST24,  HUGETURBINE_ST25,
        CASING_1,CASING_2,CASING_3,CASING_4,CASING_5,CASING_6,CASING_7,CASING_8,CASING_9,CASING_10,CASING_11,CASING_12,CASING_13,CASING_14,CASING_15,CASING_16,
        CASING_COLLIDER_CENTER,CASING_COLLIDER_CENTER_BORDER_TOP,CASING_COLLIDER_CENTER_BORDER_SIDE,GLASSCASING_2,GLASSCASING_3,GLASSCASING_4,GLASSCASING_5,GLASSCASING_6,GLASSCASING_7,GLASSCASING_8,
        COLLIDER_MIDDLE_1 ,COLLIDER_MIDDLE_2 ,COLLIDER_MIDDLE_3 ,COLLIDER_MIDDLE_4 ,COLLIDER_MIDDLE_6 ,COLLIDER_MIDDLE_7 ,COLLIDER_MIDDLE_8 ,COLLIDER_MIDDLE_9,COLLIDER_MIDDLE_DEFAULT,COLLIDER_MIDDLE_OFF_TOP,COLLIDER_MIDDLE_OFF_SIDE,COLLIDER_MIDDLE_ON_TOP,COLLIDER_MIDDLE_ON_SIDE
        ;
        ...
        public static ITexture[]
                ...
                MACHINE_CASINGS[] = new ITexture[13][17];
