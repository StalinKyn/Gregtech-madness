...
import gregtech.common.gui.GT_Container_HandTeleporter;
import gregtech.common.gui.GT_GUIContainerVolumetricFlask;
import gregtech.common.gui.GT_GUIContainer_HandTeleporter;
...
public abstract class GT_Proxy implements IGT_Mod, IGuiHandler, IFuelHandler {
    ...
    private final Collection<String> mInvalidNames = new HashSet<String>(Arrays.asList(new String[]{"diamondShard", "redstoneRoot", "obsidianStick", "bloodstoneOre",
            ...
            "osmoniumIngot", "tapaziteGem", "zectiumIngot", "foolsRsubyGem", "rubyGem", "meteoriteGem", "adamiteShard", "sapphireGem", "copperIngot",
    ...
    public boolean mResearchStationOn = true;
...
//								GT_Log.ore.println(tModToName + " uses an unknown Material. Report this to GregTech.");
    ...
    public Object getServerGuiElement(int aID, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ) {
        if(aID>=1000){
            ...
            switch(ID){
                ...
                case 11:
                    return new GT_Container_HandTeleporter(aPlayer.inventory);
                default:
    ...
    public Object getClientGuiElement(int aID, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ) {
        if(aID>=1000){
            ...
            switch(ID){
                ...
                case 11:
                    return new GT_GUIContainer_HandTeleporter(new GT_Container_HandTeleporter(aPlayer.inventory));
                default:
    ...
    public Fluid addAutogeneratedLiquefiedGasFluid(Materials aMaterial){
        return addFluid("liquefied."+aMaterial.mName.toLowerCase(Locale.ENGLISH),"liquefied.autogenerated", GT_LanguageManager.addStringLocalization("gt.metaitem.liquefied", "Liquefied ")+aMaterial.mDefaultLocalName,aMaterial,
                aMaterial.mLiquefiedRGBa[0]<0?aMaterial.mMoltenRGBa:aMaterial.mLiquefiedRGBa,1, aMaterial.mMeltingPoint,null,null,1);
    }

   /* public Fluid addAutogeneratedLiquefiedGasFluid(Materials aMaterial){
        return addFluid("liquefied."+aMaterial.mName.toLowerCase(Locale.ENGLISH),"")
    }*/
