...
public class GT_MetaTileEntity_HadronCollider extends GT_MetaTileEntity_DataWorkerBase implements IProjectable {
    ...
    public GT_MetaTileEntity_HadronCollider(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public GT_MetaTileEntity_HadronCollider(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_HadronCollider(this.mName);
    }
