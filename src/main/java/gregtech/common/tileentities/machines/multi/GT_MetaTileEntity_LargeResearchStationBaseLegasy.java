...
public abstract class GT_MetaTileEntity_LargeResearchStationBaseLegasy extends GT_MetaTileEntity_DataWorkerBaseLegasy {
    ...
    public GT_MetaTileEntity_LargeResearchStationBaseLegasy(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public GT_MetaTileEntity_LargeResearchStationBaseLegasy(String aName) {
        super(aName);
    }
